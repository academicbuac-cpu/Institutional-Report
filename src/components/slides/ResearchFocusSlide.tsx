...
import { Gavel, Coins, GraduationCap } from 'lucide-react';
const icons = [Gavel, Coins, GraduationCap];
...
export default function ResearchFocusSlide() {
  ...
  return (
    <section id="research-focus" ref={ref} className="min-h-screen flex items-center justify-center bg-college-cream py-16 px-4">
